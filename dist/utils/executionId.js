...
exports.RUN_ID_FILE_NAME = exports.DEFAULT_RUN_ID_FILE_DIR = void 0;
...
exports.DEFAULT_RUN_ID_FILE_DIR = 'test-results';
/** The fixed filename used for the run-ID handoff file within `runIdFileDir`. */
exports.RUN_ID_FILE_NAME = '.shorky-run-id';
/**
 ...
 */
function deriveDeterministicUuid(input) {
 ...
 */
function getExecutionId(runIdFileDir = exports.DEFAULT_RUN_ID_FILE_DIR) {
    ...
    const runIdFilePath = path_1.default.join(path_1.default.resolve(runIdFileDir), exports.RUN_ID_FILE_NAME);
    ...
    try {
        fs_1.default.mkdirSync(path_1.default.dirname(runIdFilePath), { recursive: true });
        fs_1.default.writeFileSync(runIdFilePath, generatedRunId, 'utf-8');
        console.log(`🆔 [Diagnostic] No GITHUB_RUN_ID/SHORKY_RUN_ID/${exports.RUN_ID_FILE_NAME} found — minted execution ID "${generatedRunId}" and persisted it to ${runIdFilePath} for any other process in this run to reuse.`);
    }
    catch (err) {
